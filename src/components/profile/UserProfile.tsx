      ...
      <Wrapper>
        {isMe ? (
          <BgImageSetting
            ...
            isShowSetting={isShowBgSetting}
            showSetting={showBgSetting}
          />
        ) : null}
        {isMe ? (
          <ProfileImageSetting
            userData={profileData}
            changeProfile={changeProfile}
            isShowSetting={isShowProfileSetting}
            showSetting={showProfileSetting}
          />
        ) : (
          <FriendProfileImage userData={profileData} />
        )}
        ...
        <ProfileText>
          ...
          {isMe ? (
            <i
              ...
              onClick={() => showStatusMsgChange(true)}
            />
          ) : null}
        </ProfileText>
      </Wrapper>
